...
// SVG oficiales de marca (los mismos vectores que dibuja react-icons/fa)
// embebidos para no depender del paquete pesado de iconos de marca.
...
const links: {
  ...
  { key: 'ig', prop: 'instagramUrl', icon: InstagramIcon, label: 'Instagram' },
  { key: 'fb', prop: 'facebookUrl', icon: FacebookIcon, label: 'Facebook' },
  { key: 'tt', prop: 'tiktokUrl', icon: TikTokIcon, label: 'TikTok' },
  { key: 'web', prop: 'webUrl', icon: () => <Globe size={18} />, label: 'Sitio Web' },
  { key: 'wa', prop: 'whatsappUrl', icon: WhatsappIcon, label: 'WhatsApp' },
]
